...
{
    public class NotificationUpdatePhoneNumberCommandTests : TestsTheoryData
    {
        private readonly NotificationUpdatePhoneNumberCommandHandler _handler;
        private readonly INotificationRepository _repository;
        private readonly IUnitOfWork _unitOfWork;
        private readonly Notification _notification;
        private readonly Procedure _procedure;

        public NotificationUpdatePhoneNumberCommandTests()
        {
            ...
            _handler = new NotificationUpdatePhoneNumberCommandHandler(_repository, _unitOfWork);
        ...
        {
            //Act
            var result = await _handler.Handle(new NotificationUpdatePhoneNumberCommand(_notification.Id, ""), default);
        ...
        {
            //Act
            var result = await _handler.Handle(new NotificationUpdatePhoneNumberCommand(Guid.Parse(id), ""), default);
